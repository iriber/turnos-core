...
use Turnos\Core\dao\impl\PlanObraSocialDoctrineDAO;
...
class DAOFactory {
	 ...
	 * 
	 * @return IPlanObraSocialDAO
	 */
	public static function getPlanObraSocialDAO(){
	
		return new PlanObraSocialDoctrineDAO();	
	}
}