 ...
 */
class Nomenclador extends \Turnos\Core\model\Nomenclador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'codigo', 'nombre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nomenclador $proxy) {
