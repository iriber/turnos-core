 ...
 */
class ObraSocial extends \Turnos\Core\model\ObraSocial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nombre', 'codigo', 'cuit', 'domicilio', 'circulo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObraSocial $proxy) {
    ...
    public function getCirculo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCirculo', array());

        return parent::getCirculo();
    }
    ...
    public function setCirculo($circulo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCirculo', array($circulo));

        return parent::setCirculo($circulo);
    }
